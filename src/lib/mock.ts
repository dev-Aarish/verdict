...
export const sampleProfile: Profile = {
  ...
  watched: Array.from({ length: 24 }).map((_, i) => ({
    id: String(i),
    title: [
      "Stalker", "Chungking Express", "Persona", "In the Mood for Love",
      "The Third Man", "Céline and Julie Go Boating", "Barry Lyndon",
      "Days of Being Wild", "Punch-Drunk Love", "Yi Yi", "L'Avventura",
      "Mulholland Drive", "The Long Goodbye", "Fanny and Alexander",
      "Playtime", "Le Samouraï", "Andrei Rublev", "Vagabond",
      "Werckmeister Harmonies", "Sátántangó", "Close-Up", "Taste of Cherry",
      "Wings of Desire", "Beau Travail",
    ][i],
    year: 1960 + ((i * 7) % 45),
    rating: 6 + ((i * 3) % 5),
  })),
...
export const globalFeed: Verdict[] = [
  ...
  { id: "c", from: "june.b → leo.v", score: 8, quote: "Reveres directors, ignores actors.", when: "14m" },
  { id: "d", from: "s_park → mira_k", score: 4, quote: "Confuses long with important.", when: "22m" },
  { id: "e", from: "annika → otto", score: 10, quote: "Genuine. Rare.", when: "31m" },
  { id: "f", from: "leo.v → annika", score: 7, quote: "Would benefit from more silence.", when: "44m" },
